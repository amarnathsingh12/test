...
export default function About() {
    ...
    const[bntn, setbntn] = useState('Enable dark mode');
    const toggles = ()=>{
  ...
  return (
    <div className="container" style={style}>
        ...
        <button onClick={toggles} type="button" class="btn btn-primary my-4">{bntn}</button>
    </div>
  )
}
